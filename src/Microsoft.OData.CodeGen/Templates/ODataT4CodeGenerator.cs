...
public abstract class ODataClientTemplate : TemplateBase
{
    ...
    /// - Prefixes <paramref name="name"/>with underscore (_) if it doesn't start with a letter, underscore, or '@'
    /// </summary>
    /// <remarks>
    ...
    private string GetValidIdentifier(string name)
    {
        ...
        if (!char.IsLetter(validName.ToString(), 0) && !validName.ToString().StartsWith(DefaultPrefixCharacter))
        {
