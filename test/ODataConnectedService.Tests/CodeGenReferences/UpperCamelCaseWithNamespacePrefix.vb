...
'Generation date: 2/9/2015 3:43:42 PM
Namespace namespacePrefix.[Namespace].Foo
    ...
    Partial Public Class TestTypeSingle
        ...
        Public ReadOnly Property SingleType() As namespacePrefix.[Namespace].Foo.SingleTypeSingle
            Get
                If Not Me.IsComposable Then
                    Throw New Global.System.NotSupportedException("The previous function is not composable.")
                End If
                If (Me._SingleType Is Nothing) Then
                    Me._SingleType = New namespacePrefix.[Namespace].Foo.SingleTypeSingle(Me.Context, GetPath("singleType"))
                End If
    ...
    Partial Public Class TestType
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        <Global.Microsoft.OData.Client.OriginalNameAttribute("singleType")>  _
        Public Property SingleType() As namespacePrefix.[Namespace].Foo.SingleType
            Get
                Return Me._SingleType
            End Get
            Set
        ...
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _SingleType As namespacePrefix.[Namespace].Foo.SingleType
        Partial Private Sub OnSingleTypeChanging(ByVal value As namespacePrefix.[Namespace].Foo.SingleType)
        End Sub
        ...
        Public Function Foo7(p1 As namespacePrefix.[Namespace].Foo.Color, p2 As namespacePrefix.[Namespace].Foo.Complex) As Global.Microsoft.OData.Client.DataServiceQuerySingle(Of String)
            Dim requestUri As Global.System.Uri = Nothing
            Context.TryGetUri(Me, requestUri)
            Return Me.Context.CreateFunctionQuerySingle(Of String)(String.Join("/", Global.System.Linq.Enumerable.Select(Global.System.Linq.Enumerable.Skip(requestUri.Segments, Me.Context.BaseUri.Segments.Length), Function(s) s.Trim("/"C))), "/namespace.foo.foo7", False, New Global.Microsoft.OData.Client.UriOperationParameter("p1", p1),
    ...
    Partial Public Class SingleTypeSingle
        ...
        Public ReadOnly Property BaseSet() As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.TestType)
            Get
                If Not Me.IsComposable Then
                    Throw New Global.System.NotSupportedException("The previous function is not composable.")
                End If
                If (Me._BaseSet Is Nothing) Then
                    Me._BaseSet = Context.CreateQuery(Of namespacePrefix.[Namespace].Foo.TestType)(GetPath("baseSet"))
                End If
                Return Me._BaseSet
            End Get
        End Property
    ...
    Partial Public Class SingleType
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Public Shared Function CreateSingleType(ByVal keyProp As Integer, ByVal colorProp As namespacePrefix.[Namespace].Foo.Color) As SingleType
        ...
        Public Property ColorProp() As namespacePrefix.[Namespace].Foo.Color
            Get
        ...
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _ColorProp As namespacePrefix.[Namespace].Foo.Color
        Partial Private Sub OnColorPropChanging(ByVal value As namespacePrefix.[Namespace].Foo.Color)
        End Sub
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        <Global.Microsoft.OData.Client.OriginalNameAttribute("baseSet")>  _
        Public Property BaseSet() As Global.System.Collections.ObjectModel.Collection(Of namespacePrefix.[Namespace].Foo.TestType)
            Get
                Return Me._BaseSet
            End Get
            Set
        ...
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _BaseSet As Global.System.Collections.ObjectModel.Collection(Of namespacePrefix.[Namespace].Foo.TestType) = New Global.System.Collections.ObjectModel.Collection(Of namespacePrefix.[Namespace].Foo.TestType)()
        Partial Private Sub OnBaseSetChanging(ByVal value As Global.System.Collections.ObjectModel.Collection(Of namespacePrefix.[Namespace].Foo.TestType))
        End Sub
        ...
        Public Function Foo8() As Global.Microsoft.OData.Client.DataServiceActionQuerySingle(Of Global.System.Nullable(Of Integer))
    ...
    Partial Public Class Complex
        ...
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Public Shared Function CreateComplex(ByVal intProp As Integer, ByVal stringProp As String) As Complex
            Dim complex As Complex = New Complex()
    ...
    Public Module ExtensionMethods
        ...
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.BaseType), ByVal keys As Global.System.Collections.Generic.Dictionary(Of String, Object)) As namespacePrefix.[Namespace].Foo.BaseTypeSingle
        ...
        ''' <param name="keys">dictionary with the names and values of keys</param>
        <Global.System.Runtime.CompilerServices.Extension()>
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.TestType), ByVal keys As Global.System.Collections.Generic.Dictionary(Of String, Object)) As namespacePrefix.[Namespace].Foo.TestTypeSingle
        ...
        ''' <param name="keys">dictionary with the names and values of keys</param>
        <Global.System.Runtime.CompilerServices.Extension()>
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.SingleType), ByVal keys As Global.System.Collections.Generic.Dictionary(Of String, Object)) As namespacePrefix.[Namespace].Foo.SingleTypeSingle
...
Namespace namespacePrefix.[Namespace].Bar
    ...
    Partial Public Class SingletonContainer
        ...
        End Sub
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private Shared ROOTNAMESPACE As String = GetType(SingletonContainer).Namespace.Remove(GetType(SingletonContainer).Namespace.LastIndexOf("namespacePrefix.Namespace.Bar"))
        '''<summary>
        ...
        Protected Function ResolveTypeFromName(ByVal typeName As String) As Global.System.Type
            Dim resolvedType As Global.System.Type = Me.DefaultResolveType(typeName, "namespace.bar", String.Concat(ROOTNAMESPACE, "namespacePrefix.Namespace.Bar"))
            If (Not (resolvedType) Is Nothing) Then
                Return resolvedType
            End If
            resolvedType = Me.DefaultResolveType(typeName, "namespace.foo", String.Concat(ROOTNAMESPACE, "namespacePrefix.Namespace.Foo"))
            If (Not (resolvedType) Is Nothing) Then
                Return resolvedType
            End If
            Return Nothing
        ...
        Protected Function ResolveNameFromType(ByVal clientType As Global.System.Type) As String
            ...
            If clientType.Namespace.Equals(String.Concat(ROOTNAMESPACE, "namespacePrefix.Namespace.Bar"), Global.System.StringComparison.OrdinalIgnoreCase) Then
            ...
            End If
            If clientType.Namespace.Equals(String.Concat(ROOTNAMESPACE, "namespacePrefix.Namespace.Foo"), Global.System.StringComparison.OrdinalIgnoreCase) Then
                If (Not (originalNameAttribute) Is Nothing) Then
        ...
        Public ReadOnly Property TestTypeSet() As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.TestType)
            Get
                If (Me._TestTypeSet Is Nothing) Then
                    Me._TestTypeSet = MyBase.CreateQuery(Of namespacePrefix.[Namespace].Foo.TestType)("testTypeSet")
                End If
                Return Me._TestTypeSet
            End Get
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _TestTypeSet As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.TestType)
        '''<summary>
        '''There are no comments for BaseTypeSet in the schema.
        '''</summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        <Global.Microsoft.OData.Client.OriginalNameAttribute("baseTypeSet")>  _
        Public ReadOnly Property BaseTypeSet() As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.BaseType)
            Get
                If (Me._BaseTypeSet Is Nothing) Then
                    Me._BaseTypeSet = MyBase.CreateQuery(Of namespacePrefix.[Namespace].Foo.BaseType)("baseTypeSet")
                End If
                Return Me._BaseTypeSet
            End Get
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _BaseTypeSet As Global.Microsoft.OData.Client.DataServiceQuery(Of namespacePrefix.[Namespace].Foo.BaseType)
        '''<summary>
        '''There are no comments for TestTypeSet in the schema.
        '''</summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Public Sub AddToTestTypeSet(ByVal testType As namespacePrefix.[Namespace].Foo.TestType)
        ...
        '''</summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Public Sub AddToBaseTypeSet(ByVal baseType As namespacePrefix.[Namespace].Foo.BaseType)
        ...
        Public ReadOnly Property SuperType() As namespacePrefix.[Namespace].Foo.TestTypeSingle
            Get
                If (Me._SuperType Is Nothing) Then
                    Me._SuperType = New namespacePrefix.[Namespace].Foo.TestTypeSingle(Me, "superType")
                End If
                Return Me._SuperType
            End Get
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _SuperType As namespacePrefix.[Namespace].Foo.TestTypeSingle
        '''<summary>
        '''There are no comments for Single in the schema.
        '''</summary>
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        <Global.Microsoft.OData.Client.OriginalNameAttribute("single")>  _
        Public ReadOnly Property [Single]() As namespacePrefix.[Namespace].Foo.SingleTypeSingle
            Get
                If (Me._Single Is Nothing) Then
                    Me._Single = New namespacePrefix.[Namespace].Foo.SingleTypeSingle(Me, "single")
                End If
                Return Me._Single
            End Get
        End Property
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
        Private _Single As namespacePrefix.[Namespace].Foo.SingleTypeSingle
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.OData.Client.Design.T4", "2.2.0")>  _
 ...
 "      </EntityType>" & _
 "      <ComplexType Name=""complex"">" & _
 "        <Property Name=""intProp"" Type=""Edm.Int32"" Nullable=""false"" />" & _
 "        <Property Name=""stringProp"" Type=""Edm.String"" Nullable=""false"" />" & _
 "      </ComplexType>" & _
 ...
 "        <Parameter Name=""p1"" Type=""namespace.foo.testType"" />" & _
 "        <Parameter Name=""p1"" Type=""namespace.foo.color"" Nullable=""false"" />" & _
 "        <Parameter Name=""p2"" Type=""namespace.foo.complex"" />" & _
 "        <ReturnType Type=""Edm.String"" />" & _
 "      </Function>" & _
 "      <Action Name=""foo8"" IsBound=""True"">" & _
 "        <Parameter Name=""p1"" Type=""namespace.foo.singleType"" />" & _
 "        <ReturnType Type=""Edm.Int32"" />" & _
 "      </Action>" & _
 "      <Action Name=""foo9"">" & _
 "        <Parameter Name=""p1"" Type=""namespace.foo.color"" />" & _
 "        <Parameter Name=""p2"" Type=""namespace.foo.complex"" />" & _
 "      </Action>" & _
 "    </Schema>" & _
 ...
 "        <ActionImport Name=""foo9"" Action=""namespace.foo.foo9"" />" & _
 "      </EntityContainer>" & _
 "    </Schema>" & _
 "  </edmx:DataServices>" & _
 "</edmx:Edmx>"
        ...
        Public Function Foo6(p1 As Global.System.Collections.Generic.ICollection(Of namespacePrefix.[Namespace].Foo.TestType), Optional ByVal useEntityReference As Boolean = False) As Global.Microsoft.OData.Client.DataServiceQuerySingle(Of String)
        ...
        ''' </summary>
        <Global.Microsoft.OData.Client.OriginalNameAttribute("foo9")>  _
        Public Function Foo9(p1 As Global.System.Nullable(Of namespacePrefix.[Namespace].Foo.Color), p2 As namespacePrefix.[Namespace].Foo.Complex) As Global.Microsoft.OData.Client.DataServiceActionQuery
            Return New Global.Microsoft.OData.Client.DataServiceActionQuery(Me, Me.BaseUri.OriginalString.Trim("/"C) + "/foo9", New Global.Microsoft.OData.Client.BodyOperationParameter("p1", p1),
