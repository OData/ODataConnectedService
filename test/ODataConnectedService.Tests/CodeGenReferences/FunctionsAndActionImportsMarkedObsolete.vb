...
'Generation date: 07/04/2021 12:25:14
Namespace Namespace1
 ...
 "      </EntityType>" & _
 "      <Function Name=""GetCheapestProduct"">" & _
 "        <ReturnType Type=""Namespace1.Product"" />" & _
 "      </Function>" & _
 ...
 "        <FunctionImport Name=""GetCheapestProduct"" Function=""Namespace1.GetCheapestProduct"" EntitySet=""Products"">" & _
 ...
 "                <PropertyValue Property=""Description"" String=""The Service has deprecated the GetCheapestProduct Function and will stop returning data on August 20, 2022."" />" & _
 "                <PropertyValue Property=""RemovalDate"" Date=""2022-08-20"" />" & _
 "              </Record>" & _
 "            </Collection>" & _
 "          </Annotation>" & _
 "        </FunctionImport>" & _
 "        <ActionImport Name=""ResetDataSource"" Action=""Namespace1.ResetDataSource"">" & _
 "          <Annotation Term=""Org.OData.Core.V1.Revisions"">" & _
 "            <Collection>" & _
 "              <Record>" & _
 "                <PropertyValue Property=""Date"" Date=""2020-08-20"" />" & _
 "                <PropertyValue Property=""Version"" String=""2020-08/Tasks_And_Plans"" />" & _
 "                <PropertyValue Property=""Kind"" EnumMember=""Org.OData.Core.V1.RevisionKind/Deprecated"" />" & _
 "                <PropertyValue Property=""Description"" String=""The Service has deprecated the ResetDataSource Action and will stop returning data on August 20, 2022."" />" & _
 "                <PropertyValue Property=""RemovalDate"" Date=""2022-08-20"" />" & _
 "              </Record>" & _
 "            </Collection>" & _
 "          </Annotation>" & _
 ...
 "</edmx:Edmx>"
        ...
        End Class
        ''' <summary>
        ''' There are no comments for GetCheapestProduct in the schema.
        ''' </summary>
        <Global.System.ObsoleteAttribute("The Service has deprecated the GetCheapestProduct Function and will stop returning data on August 20, 2022.")>  _
        Public Overridable Function GetCheapestProduct() As Namespace1.ProductSingle
            Return New Namespace1.ProductSingle(Me.CreateFunctionQuerySingle(Of Namespace1.Product)("", "/GetCheapestProduct", False))
        End Function
        ''' <summary>
        ''' There are no comments for ResetDataSource in the schema.
        ''' </summary>
        <Global.System.ObsoleteAttribute("The Service has deprecated the ResetDataSource Action and will stop returning data on August 20, 2022.")>  _
