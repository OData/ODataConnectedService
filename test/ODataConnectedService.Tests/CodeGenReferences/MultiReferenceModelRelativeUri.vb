...
'Generation date: 10.03.2021 19:43:19
Namespace Microsoft.OData.SampleService.Models.ModelRefDemo.TruckDemo
    ...
    Partial Public Class TruckDemoService
        ...
        Private MustInherit Class GeneratedEdmModel
            ...
            Private Shared ReferencesMap As Global.System.Collections.Generic.Dictionary(Of String, String) = New Global.System.Collections.Generic.Dictionary(Of String, String) From
                {
                    {"./MultiReferenceModelCoreTerms.xml", "<edmx:Edmx xmlns:edmx=""http://docs.oasis-open.org/odata/ns/edmx"" Version=""4.0"">" & _
 "  <edmx:DataServices>" & _
 ...
 "  </edmx:DataServices>" & _
 "</edmx:Edmx>"},
                    {"./MultiReferenceModelDeviceModelTerms.xml", "<edmx:Edmx xmlns:edmx=""http://docs.oasis-open.org/odata/ns/edmx"" Version=""4.0"">" & _
 ...
 "  </edmx:DataServices>" & _
 "</edmx:Edmx>"},
                    {"./MultiReferenceModelGPS.xml", "<edmx:Edmx xmlns:edmx=""http://docs.oasis-open.org/odata/ns/edmx"" Version=""4.0"">" & _
 ...
 "  </edmx:DataServices>" & _
 "</edmx:Edmx>"},
                    {"./MultiReferenceModelLocation.xml", "<edmx:Edmx xmlns:edmx=""http://docs.oasis-open.org/odata/ns/edmx"" Version=""4.0"">" & _
 "  <edmx:Reference Uri=""http://odatae2etest.azurewebsites.net/demo/ModelRefService/DeviceModelTerms.csdl"">" & _
 "    <edmx:Include Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.Vocabulary.V1"" Alias=""IoTDeviceModel"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:DataServices>" & _
 ...
 "  </edmx:DataServices>" & _
 "</edmx:Edmx>"},
                    {"./MultiReferenceModelMap.xml", "<edmx:Edmx xmlns:edmx=""http://docs.oasis-open.org/odata/ns/edmx"" Version=""4.0"">" & _
 "  <edmx:DataServices>" & _
 ...
 "  <edmx:Reference Uri=""./MultiReferenceModelCoreTerms.xml"">" & _
 "    <edmx:Include Alias=""Core"" Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.Core.V1"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:Reference Uri=""./MultiReferenceModelDeviceModelTerms.xml"">" & _
 "    <edmx:Include Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.Vocabulary.V1"" Alias=""IoTDeviceModel"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:Reference Uri=""./MultiReferenceModelGPS.xml"">" & _
 "    <edmx:Include Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.GPS"" Alias=""GPS"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:Reference Uri=""./MultiReferenceModelLocation.xml"">" & _
 "    <edmx:Include Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.Location"" Alias=""Location"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:Reference Uri=""./MultiReferenceModelMap.xml"">" & _
 "    <edmx:Include Namespace=""Microsoft.OData.SampleService.Models.ModelRefDemo.Map"" Alias=""Map"" />" & _
 "  </edmx:Reference>" & _
 "  <edmx:DataServices>" & _
 ...
 "</edmx:Edmx>"
        ...
        ''' </summary>
        Public Overridable Function GetDefaultOutsideGeoFenceAlarm() As Global.Microsoft.OData.Client.DataServiceQuerySingle(Of Microsoft.OData.SampleService.Models.ModelRefDemo.Location.OutsideGeoFenceAlarmType)
        ...
        ''' </summary>
        Public Overridable Function ResetVehicleSpeedToValue(targetValue As Global.System.Nullable(Of Double)) As Global.Microsoft.OData.Client.DataServiceActionQuery(Of Microsoft.OData.SampleService.Models.ModelRefDemo.GPS.VehicleGPSType)
...
Namespace Microsoft.OData.SampleService.Models.ModelRefDemo.GPS
 ...
 "</edmx:Edmx>"
    ...
    Partial Public Class VehicleGPSType
        ...
        ''' </summary>
        Public Overridable Function GetVehicleSpeed() As Global.Microsoft.OData.Client.DataServiceQuerySingle(Of Double)
