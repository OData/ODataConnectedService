...
Namespace Namespace1.DSC
 ...
 "</edmx:Edmx>"
    ...
    Public Module ExtensionMethods
        ...
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Namespace1.DSC.EntityType), ByVal keys As Global.System.Collections.Generic.IDictionary(Of String, Object)) As Namespace1.DSC.EntityTypeSingle
            Return New Namespace1.DSC.EntityTypeSingle(source.Context, source.GetKeyPath(Global.Microsoft.OData.Client.Serializer.GetKeyString(source.Context, keys)))
        End Function
        ''' <summary>
        ''' Get an entity of type Namespace1.DSC.EntityType as Namespace1.DSC.EntityTypeSingle specified by key from an entity set
        ''' </summary>
        ...
        <Global.System.Runtime.CompilerServices.Extension()>
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Namespace1.DSC.EntityType),
