...
'Generation date: 2/9/2015 10:26:52 AM
Namespace Simple
    '''<summary>
    ...
    Public Module ExtensionMethods
        ...
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Simple.TestType), ByVal keys As Global.System.Collections.Generic.Dictionary(Of String, Object)) As Simple.TestTypeSingle
            Return New Simple.TestTypeSingle(source.Context, source.GetKeyPath(Global.Microsoft.OData.Client.Serializer.GetKeyString(source.Context, keys)))
        End Function
        ''' <summary>
        ''' Get an entity of type Simple.TestType as Simple.TestTypeSingle specified by key from an entity set
        ''' </summary>
        ...
        <Global.System.Runtime.CompilerServices.Extension()>
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Simple.TestType),
